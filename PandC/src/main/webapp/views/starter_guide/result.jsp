...
<body class="d-flex flex-column h-100">
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="feature col">
        <div>
          <img src="https://cdn-icons-png.flaticon.com/128/2583/2583434.png" width="65" height="55" alt=""><img>
        </div>
        <h2>Featured title</h2>
        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
        <a href="#" class="icon-link">
      ...
      <div class="feature col">
        <div>
          <img src="https://previews.123rf.com/images/barks/barks1712/barks171200526/91751886-ranking-medal-icon-illustration-4th-place-.jpg" alt="" width="65" height="55"></img>
        </div>
        <h2>Featured title</h2>
        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
        <a href="#" class="icon-link">
